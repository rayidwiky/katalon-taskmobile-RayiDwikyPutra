...
Mobile.comment("Sisa Quantity: $Quantity")

Mobile.tap(findTestObject('Desc_Product/Btn_addCart'), 0)

Mobile.setText(findTestObject('Desc_Product/Edt_NmbrOrder'), '6', 0)

Mobile.tap(findTestObject('Desc_Product/Btn_Add'), 0)

Mobile.tap(findTestObject('Desc_Product/Btn_MyCart'), 0)

def Label_EmptyCart = Mobile.getText(findTestObject('Shopping_Cart/Lbl_EmptyCart'), 10)
